...
This will change both F- and R-symbols, so the pentagon and hexagon equations will be re-checked for security."

donotcheckpentagon::usage =
	"Run donotcheckpentagon[] if you do not want the pentagon equations to be checked. \
...
docheckpentagon::usage =
	"Run docheckpentagon[] if you ran donotcheckpentagon[] accidentally, but still want to check the pentagon equations."

displayinfo::usage = 
	"displayinfo[] displays some general information and basic instructions on how to use the package."
...
Nvertex::usage =
	"Nv[a,b,c] gives the number of vertices of type (a,b,c)."
	
Fusion::usage =
	"Fusion[a,b] gives the possible fusion outcomes of a x b, that is, without(!) \
taking fusion multiplicities into account."
...
displayinfo[] := With[{},
   ...
   codeStyle = 
    Style[ #,  FontSize -> 12, FontFamily -> "Source Code Pro" ] &;
   ...
   Print[Sequence @@
     {
      ...
      Style[ "Many thanks to: Joost Slingerland, Gert Vercleyen\n" , 
       FontSize -> 12, FontFamily -> "Helvetica Neue", Bold],
      Style[ 
...
groups,\n" , FontSize -> 12, FontFamily -> "Helvetica Neue", Italic],
      ...
      textStyle["\nLast revision of the package: 2021-10-18\n"],
      textStyle[
